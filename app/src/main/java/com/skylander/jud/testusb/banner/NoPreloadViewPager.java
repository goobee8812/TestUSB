...
public class NoPreloadViewPager extends ViewGroup {
    private static final String TAG = "HHHHH";
...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     * exchange_rate_layout there will be a smooth animated transition between the current item and the
     * specified item.
     *
     ...
     * that you can keep active all at once, less time will be spent in exchange_rate_layout for
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // We depend on the container to specify the exchange_rate_layout size of
        // our view.  We can't really know what it is since we will be
        // adding and removing different arbitrary views and do not
        // want the exchange_rate_layout to change as this happens.
